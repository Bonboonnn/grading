                ...
                <section class="content">
					<div class="row container-fluid">
						...
						<div class="col-lg-2 col-md-2">
							<button class="btn btn-block btn-primary" data-target="#insertUpdateModal" data-toggle="modal">Add student Subject</button>
						</div>
						<div class="col-12">
							<hr>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="form-group">
										...
										<input type="text" name="Subject Code" class="form-control" placeholder="Subject Code" required>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
										<label>Unit</label>
										<input type="number" name="unit" class="form-control" placeholder="Unit(s)" required>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
